...
proc create_root_design { parentCell } {
  ...
  set din1 [ create_bd_port -dir I din1 ]
  set din2 [ create_bd_port -dir I din2 ]
  set sclk [ create_bd_port -dir O sclk ]

  # Create instance: adc_sampler_0, and set properties
  set block_name adc_sampler
  set block_cell_name adc_sampler_0
  if { [catch {set adc_sampler_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $adc_sampler_0 eq "" } {
  ...
  connect_bd_net -net adc_sampler_0_clk_5_12M [get_bd_ports sclk] [get_bd_pins adc_sampler_0/clk_5_12M]
  connect_bd_net -net adc_sampler_0_cs_n [get_bd_ports cs_n] [get_bd_pins adc_sampler_0/cs_n]
  connect_bd_net -net adc_sampler_0_data_out [get_bd_pins adc_sampler_0/data_out] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net adc_sampler_0_intr_sw [get_bd_pins adc_sampler_0/intr_sw] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net axi_gpio_0_ip2intc_irpt [get_bd_pins axi_gpio_0/ip2intc_irpt] [get_bd_pins processing_system7_0/IRQ_F2P]
  connect_bd_net -net din1_0_1 [get_bd_ports din1] [get_bd_pins adc_sampler_0/din1]
  connect_bd_net -net din2_0_1 [get_bd_ports din2] [get_bd_pins adc_sampler_0/din2]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins adc_sampler_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins adc_sampler_0/rst_n] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
